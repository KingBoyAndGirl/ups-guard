...
> 测试时间: 2026-03-11 21:11:33  
> NUT 驱动: nutdrv_qx 2.8.2
...
| 🆕 | `ups.firmware.aux` | `PM-P` | UPS辅助固件版本 |
| 🔵 | `ups.load` | `0` | UPS负载(%) |
...
| 状态 | 变量名 | 值 | 描述 |
|:----:|--------|-----|------|
| 🔵 | `input.voltage` | `224.5` | 输入电压(V) |

### 📁 输出电源 (2 个变量)

| 状态 | 变量名 | 值 | 描述 |
|:----:|--------|-----|------|
| 🔵 | `output.frequency` | `50.9` | 输出频率(Hz) |
| 🔵 | `output.voltage` | `224.5` | 输出电压(V) |
...
| 🆕 | `driver.parameter.pollinterval` | `2` | 轮询间隔 |
...
| 状态 | 变量名 | 值 | 描述 |
|:----:|--------|-----|------|
| 🆕 | `driver.version.data` | `Voltronic-QS-Hex 0.10` | 数据版本 |
| 🆕 | `driver.version.internal` | `0.36` | 内部驱动版本 |
...
| `driver.parameter.pollinterval` | 2 | ⚙️ entrypoint.sh | USB 轮询间隔，减少通信压力 |
